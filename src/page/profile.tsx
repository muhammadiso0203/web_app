...
const Profile = () => {
    ...
    return (
        <div className="p-6 pt-10 min-h-screen bg-background text-foreground">
            <motion.div
            ...
            >
                ...
                <p className="text-muted-foreground">@{user?.username || "scholar"}</p>
            </motion.div>
            ...
            <div className="space-y-4">
                <div className="glass-card p-5 space-y-4">
                    ...
                    <div className="flex items-center gap-4 text-foreground border-t border-white/5 pt-4">
